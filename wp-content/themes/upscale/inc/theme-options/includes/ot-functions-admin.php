          ...
          array(
            ...
            'pages'               => array( 
              array(
                ...
                'page_title'      => apply_filters( 'ot_theme_options_page_title', esc_html__( 'Theme Options', 'upscale' ) ),
                'menu_title'      => apply_filters( 'ot_theme_options_menu_title', esc_html__( 'Theme Options', 'upscale' ) ),
                ...
                'updated_message' => apply_filters( 'ot_theme_options_updated_message', esc_html__( 'Theme Options updated.', 'upscale' ) ),
                'reset_message'   => apply_filters( 'ot_theme_options_reset_message', esc_html__( 'Theme Options reset.', 'upscale' ) ),
                'button_text'     => apply_filters( 'ot_theme_options_button_text', esc_html__( 'Save Changes', 'upscale' ) ),
  ...
  function ot_register_settings_page() {
    ...
    if ( OT_SHOW_OPTIONS_UI == true && isset( $_REQUEST['page'] ) && $_REQUEST['page'] == 'ot-settings' && ( $ot_has_custom_theme_options == true || has_action( 'admin_init', 'custom_theme_options' ) || has_action( 'init', 'custom_theme_options' ) ) ) {
      ...
      function ot_has_custom_theme_options() {
        ...
        echo '<div class="error"><p>' . esc_html__( 'The Theme Options UI Builder is being overridden by a custom file in your theme. Any changes you make via the UI Builder will not be saved.', 'upscale' ) . '</p></div>';
    ...
    $ot_register_pages_array =  array( 
      array( 
        'id'              => 'ot',
        'page_title'      => esc_html__( 'OptionTree', 'upscale' ),
        'menu_title'      => esc_html__( 'OptionTree', 'upscale' ),
      ...
      array(
        ...
        'page_title'      => esc_html__( 'Settings', 'upscale' ),
        'menu_title'      => esc_html__( 'Settings', 'upscale' ),
        'capability'      => 'edit_theme_options',
        'menu_slug'       => 'ot-settings',
        'icon_url'        => null,
        'position'        => null,
        'updated_message' => esc_html__( 'Theme Options updated.', 'upscale' ),
        'reset_message'   => esc_html__( 'Theme Options reset.', 'upscale' ),
        'button_text'     => esc_html__( 'Save Settings', 'upscale' ),
        'show_buttons'    => false,
        'sections'        => array(
          array(
            'id'          => 'create_setting',
            'title'       => esc_html__( 'Theme Options UI', 'upscale' )
          ),
          array(
            'id'          => 'import',
            'title'       => esc_html__( 'Import', 'upscale' )
          ),
          array(
            'id'          => 'export',
            'title'       => esc_html__( 'Export', 'upscale' )
          ),
          array(
            'id'          => 'layouts',
            'title'       => esc_html__( 'Layouts', 'upscale' )
          )
        ),
        'settings'        => array(
          array(
            'id'          => 'theme_options_ui_text',
            'label'       => esc_html__( 'Theme Options UI Builder', 'upscale' ),
            'type'        => 'theme_options_ui',
            'section'     => 'create_setting'
          ),
          array(
            'id'          => 'import_xml_text',
            'label'       => esc_html__( 'Settings XML', 'upscale' ),
            'type'        => 'import-xml',
            'section'     => 'import'
          ),
          array(
            'id'          => 'import_settings_text',
            'label'       => esc_html__( 'Settings', 'upscale' ),
            'type'        => 'import-settings',
            'section'     => 'import'
          ),
          array(
            'id'          => 'import_data_text',
            'label'       => esc_html__( 'Theme Options', 'upscale' ),
            'type'        => 'import-data',
            'section'     => 'import'
          ),
          array(
            'id'          => 'import_layouts_text',
            'label'       => esc_html__( 'Layouts', 'upscale' ),
            'type'        => 'import-layouts',
            'section'     => 'import'
          ),
          array(
            'id'          => 'export_settings_file_text',
            'label'       => esc_html__( 'Settings PHP File', 'upscale' ),
          ...
          array(
            ...
            'label'       => esc_html__( 'Layout Management', 'upscale' ),
            'type'        => 'modify-layouts',
            'section'     => 'layouts'
          )
        )
      ...
      array(
        'id'              => 'documentation',
        'parent_slug'     => 'ot-settings',
        'page_title'      => esc_html__( 'Documentation', 'upscale' ),
        'menu_title'      => esc_html__( 'Documentation', 'upscale' ),
        'capability'      => 'edit_theme_options',
        ...
        'sections'        => array(
          array(
            'id'          => 'creating_options',
            'title'       => esc_html__( 'Creating Options', 'upscale' )
          ),
          array(
            'id'          => 'option_types',
            'title'       => esc_html__( 'Option Types', 'upscale' )
          ),
          array(
            'id'          => 'functions',
            'title'       => esc_html__( 'Function References', 'upscale' )
          ),
          array(
            'id'          => 'theme_mode',
            'title'       => esc_html__( 'Theme Mode', 'upscale' )
          ),
          array(
            'id'          => 'meta_boxes',
            'title'       => esc_html__( 'Meta Boxes', 'upscale' )
          ),
          array(
            'id'          => 'examples',
            'title'       => esc_html__( 'Code Examples', 'upscale' )
          ),
          array(
            'id'          => 'layouts_overview',
            'title'       => esc_html__( 'Layouts Overview', 'upscale' )
          )
        ),
        'settings'        => array(
          array(
            'id'          => 'creating_options_text',
            'label'       => esc_html__( 'Overview of available Theme Option fields.', 'upscale' ),
            'type'        => 'creating-options',
            'section'     => 'creating_options'
          ),
          array(
            'id'          => 'option_types_text',
            'label'       => esc_html__( 'Option types in alphabetical order & hooks to filter them.', 'upscale' ),
            'type'        => 'option-types',
            'section'     => 'option_types'
          ),
          array(
            'id'          => 'functions_ot_get_option',
            'label'       => esc_html__( 'Function Reference:ot_get_option()', 'upscale' ),
            'type'        => 'ot-get-option',
            'section'     => 'functions'
          ),
          array(
            'id'          => 'functions_get_option_tree',
            'label'       => esc_html__( 'Function Reference:get_option_tree()', 'upscale' ),
            'type'        => 'get-option-tree',
            'section'     => 'functions'
          ),
          array(
            'id'          => 'theme_mode_text',
            'label'       => esc_html__( 'Theme Mode', 'upscale' ),
            'type'        => 'theme-mode',
            'section'     => 'theme_mode'
          ),
          array(
            'id'          => 'meta_boxes_text',
            'label'       => esc_html__( 'Meta Boxes', 'upscale' ),
            'type'        => 'meta-boxes',
            'section'     => 'meta_boxes'
          ),
          array(
            'id'          => 'example_text',
            'label'       => esc_html__( 'Code examples for front-end development.', 'upscale' ),
            'type'        => 'examples',
            'section'     => 'examples'
          ),
          array(
            'id'          => 'layouts_overview_text',
            'label'       => esc_html__( 'What\'s a layout anyhow?', 'upscale' ),
    ...
    if ( 'background' == $type ) {
      ...
      foreach( $input as $key => $value ) {
        ...
        if ( $key == 'width' && ! empty( $value ) && ! is_numeric( $value ) ) {
          ...
          add_settings_error( 'option-tree', 'invalid_border_width', sprintf( esc_html__( 'The %s input field for %s only allows numeric values.', 'upscale' ), '<code>width</code>', '<code>' . $field_id . '</code>' ), 'error' );
      ...
      if ( 0 === preg_match( '/^#([a-f0-9]{6}|[a-f0-9]{3})$/i', $input ) && 0 === preg_match( '/^rgba\(\s*([0-9]{1,3})\s*,\s*([0-9]{1,3})\s*,\s*([0-9]{1,3})\s*,\s*([0-9\.]{1,4})\s*\)/i', $input ) ) {
        ...
        add_settings_error( 'option-tree', 'invalid_hex', sprintf( esc_html__( 'The %s Colorpicker only allows valid hexadecimal or rgba values.', 'upscale' ), '<code>' . $field_id . '</code>' ), 'error' );
      ...
      if ( isset( $errors ) ) {
        ...
        foreach( $errors as $error ) {
          ...
          add_settings_error( 'option-tree', 'invalid_dimension_' . $error, sprintf( esc_html__( 'The %s input field for %s only allows numeric values.', 'upscale' ), '<code>' . $error . '</code>', '<code>' . $field_id . '</code>' ), 'error' );
      ...
      if ( isset( $errors ) ) {
        ...
        foreach( $errors as $error ) {
          ...
          add_settings_error( 'option-tree', 'invalid_spacing_' . $error, sprintf( esc_html__( 'The %s input field for %s only allows numeric values.', 'upscale' ), '<code>' . $error . '</code>', '<code>' . $field_id . '</code>' ), 'error' );
...
if ( ! function_exists( 'ot_admin_scripts' ) ) {
  ...
  function ot_admin_scripts() {
    ...
    $localized_array = array( 
      ...
      'upload_text'           => apply_filters( 'ot_upload_text', esc_html__( 'Send to OptionTree', 'upscale' ) ),
      'remove_media_text'     => esc_html__( 'Remove Media', 'upscale' ),
      'reset_agree'           => esc_html__( 'Are you sure you want to reset back to the defaults?', 'upscale' ),
      'remove_no'             => esc_html__( 'You can\'t remove this! But you can edit the values.', 'upscale' ),
      'remove_agree'          => esc_html__( 'Are you sure you want to remove this?', 'upscale' ),
      'activate_layout_agree' => esc_html__( 'Are you sure you want to activate this layout?', 'upscale' ),
      'setting_limit'         => esc_html__( 'Sorry, you can\'t have settings three levels deep.', 'upscale' ),
      'delete'                => esc_html__( 'Delete Gallery', 'upscale' ), 
      'edit'                  => esc_html__( 'Edit Gallery', 'upscale' ), 
      'create'                => esc_html__( 'Create Gallery', 'upscale' ), 
      'confirm'               => esc_html__( 'Are you sure you want to delete this Gallery?', 'upscale' ),
      'date_current'          => esc_html__( 'Today', 'upscale' ),
      'date_time_current'     => esc_html__( 'Now', 'upscale' ),
      'date_close'            => esc_html__( 'Close', 'upscale' ),
      'replace'               => esc_html__( 'Featured Image', 'upscale' ),
      'with'                  => esc_html__( 'Image', 'upscale' )
    );
...
if ( ! function_exists( 'ot_create_media_post' ) ) {
  ...
  function ot_create_media_post() {
    ...
    $regsiter_post_type( 'option-tree', array(
      'labels'              => array( 'name' => esc_html__( 'Option Tree', 'upscale' ) ),
      'public'              => false,
      'show_ui'             => false,
      ...
      if ( ! isset( $settings['sections'] ) || ! isset( $settings['settings'] ) ) {
        ...
        $settings = array(
          'sections' => array(
            array(
              'id'        => 'general',
              'title'     => esc_html__( 'General', 'upscale' )
            )
          ),
          'settings' => array(
            array(
              'id'        => 'sample_text',
              'label'     => esc_html__( 'Sample Text Field Label', 'upscale' ),
              'desc'      => esc_html__( 'Description for the sample text field.', 'upscale' ),
              'section'   => 'general',
              'type'      => 'text',
              'std'       => '',
              'class'     => '',
  ...
  function ot_alert_message( $page = array() ) {
    ...
    if ( $action == 'save-settings' ) {
      ...
      if ( $message == 'success' ) {
        ...
        return '<div id="message" class="updated fade below-h2"><p>' . esc_html__( 'Settings updated.', 'upscale' ) . '</p></div>';
        
      } else if ( $message == 'failed' ) {
        
        return '<div id="message" class="error fade below-h2"><p>' . esc_html__( 'Settings could not be saved.', 'upscale' ) . '</p></div>';
      ...
      if ( $message == 'success' ) {
        ...
        return '<div id="message" class="updated fade below-h2"><p>' . esc_html__( 'Settings Imported.', 'upscale' ) . '</p></div>';
        
      } else if ( $message == 'failed' ) {
        
        return '<div id="message" class="error fade below-h2"><p>' . esc_html__( 'Settings could not be imported.', 'upscale' ) . '</p></div>';
      ...
      if ( $message == 'success' ) {
        ...
        return '<div id="message" class="updated fade below-h2"><p>' . esc_html__( 'Data Imported.', 'upscale' ) . '</p></div>';
        
      } else if ( $message == 'failed' ) {
        
        return '<div id="message" class="error fade below-h2"><p>' . esc_html__( 'Data could not be imported.', 'upscale' ) . '</p></div>';
      ...
      if ( $message == 'success' ) {
        ...
        return '<div id="message" class="updated fade below-h2"><p>' . esc_html__( 'Layouts Imported.', 'upscale' ) . '</p></div>';
        
      } else if ( $message == 'failed' ) {
        
        return '<div id="message" class="error fade below-h2"><p>' . esc_html__( 'Layouts could not be imported.', 'upscale' ) . '</p></div>';
      ...
      if ( $message == 'success' ) {
        ...
        return '<div id="message" class="updated fade below-h2"><p>' . esc_html__( 'Layouts Updated.', 'upscale' ) . '</p></div>';
        
      } else if ( $message == 'failed' ) {
        
        return '<div id="message" class="error fade below-h2"><p>' . esc_html__( 'Layouts could not be updated.', 'upscale' ) . '</p></div>';
        
      } else if ( $message == 'deleted' ) {
        
        return '<div id="message" class="updated fade below-h2"><p>' . esc_html__( 'Layouts have been deleted.', 'upscale' ) . '</p></div>';
        
      }
    
    } else if ( $updated == 'layout' ) {  
       
      return '<div id="message" class="updated fade below-h2"><p>' . esc_html__( 'Layout activated.', 'upscale' ) . '</p></div>';
...
if ( ! function_exists( 'ot_option_types_array' ) ) {
  ...
  function ot_option_types_array() {
    ...
    return apply_filters( 'ot_option_types_array', array( 
      'background'                => esc_html__('Background', 'upscale'),
      'border'                    => esc_html__('Border', 'upscale'),
      'box-shadow'                => esc_html__('Box Shadow', 'upscale'),
      'category-checkbox'         => esc_html__('Category Checkbox', 'upscale'),
      'category-select'           => esc_html__('Category Select', 'upscale'),
      'checkbox'                  => esc_html__('Checkbox', 'upscale'),
      'colorpicker'               => esc_html__('Colorpicker', 'upscale'),
      'colorpicker-opacity'       => esc_html__('Colorpicker Opacity', 'upscale'),
      'css'                       => esc_html__('CSS', 'upscale'),
      'custom-post-type-checkbox' => esc_html__('Custom Post Type Checkbox', 'upscale'),
      'custom-post-type-select'   => esc_html__('Custom Post Type Select', 'upscale'),
      'date-picker'               => esc_html__('Date Picker', 'upscale'),
      'date-time-picker'          => esc_html__('Date Time Picker', 'upscale'),
      'dimension'                 => esc_html__('Dimension', 'upscale'),
      'gallery'                   => esc_html__('Gallery', 'upscale'),
      'google-fonts'              => esc_html__('Google Fonts', 'upscale'),
      'javascript'                => esc_html__('JavaScript', 'upscale'),
      'link-color'                => esc_html__('Link Color', 'upscale'),
      'list-item'                 => esc_html__('List Item', 'upscale'),
      'measurement'               => esc_html__('Measurement', 'upscale'),
      'numeric-slider'            => esc_html__('Numeric Slider', 'upscale'),
      'on-off'                    => esc_html__('On/Off', 'upscale'),
      'page-checkbox'             => esc_html__('Page Checkbox', 'upscale'),
      'page-select'               => esc_html__('Page Select', 'upscale'),
      'post-checkbox'             => esc_html__('Post Checkbox', 'upscale'),
      'post-select'               => esc_html__('Post Select', 'upscale'),
      'radio'                     => esc_html__('Radio', 'upscale'),
      'radio-image'               => esc_html__('Radio Image', 'upscale'),
      'select'                    => esc_html__('Select', 'upscale'),
      'sidebar-select'            => esc_html__('Sidebar Select',  'upscale'),
      'slider'                    => esc_html__('Slider', 'upscale'),
      'social-links'              => esc_html__('Social Links', 'upscale'),
      'spacing'                   => esc_html__('Spacing', 'upscale'),
      'tab'                       => esc_html__('Tab', 'upscale'),
      'tag-checkbox'              => esc_html__('Tag Checkbox', 'upscale'),
      'tag-select'                => esc_html__('Tag Select', 'upscale'),
      'taxonomy-checkbox'         => esc_html__('Taxonomy Checkbox', 'upscale'),
      'taxonomy-select'           => esc_html__('Taxonomy Select', 'upscale'),
      'text'                      => esc_html__('Text', 'upscale'),
      'textarea'                  => esc_html__('Textarea', 'upscale'),
      'textarea-simple'           => esc_html__('Textarea Simple', 'upscale'),
      'textblock'                 => esc_html__('Textblock', 'upscale'),
      'textblock-titled'          => esc_html__('Textblock Titled', 'upscale'),
      'typography'                => esc_html__('Typography', 'upscale'),
      'upload'                    => esc_html__('Upload', 'upscale')
    ) );
...
if ( ! function_exists( 'ot_radio_images' ) ) {
  ...
  function ot_radio_images( $field_id = '' ) {
    ...
    return apply_filters( 'ot_radio_images', array(
      ...
      array(
        'value'   => 'full-width',
        'label'   => esc_html__( 'Full Width (no sidebar)', 'upscale' ),
...
if ( ! function_exists( 'ot_list_item_settings' ) ) {
  ...
  function ot_list_item_settings( $id ) {
    ...
    $settings = apply_filters( 'ot_list_item_settings', array(
      array(
        'id'        => 'image',
        'label'     => esc_html__( 'Image', 'upscale' ),
        'desc'      => '',
        'std'       => '',
        'type'      => 'upload',
        'rows'      => '',
      ...
      array(
        'id'        => 'description',
        'label'     => esc_html__( 'Description', 'upscale' ),
        'desc'      => '',
        'std'       => '',
  ...
  function ot_social_links_settings( $id ) {
    ...
    $settings = apply_filters( 'ot_social_links_settings', array(
      array(
        ...
        'desc'      => esc_html__( 'Enter the name of the social website.', 'upscale' ),
        'std'       => '',
        'type'      => 'text',
      ...
      array(
        'id'        => 'title',
        'label'     => 'Title',
        'desc'      => esc_html__( 'Enter the text shown in the title attribute of the link.', 'upscale' ),
        'type'      => 'text'
      ),
      array(
        'id'        => 'href',
        'label'     => 'Link',
        'desc'      => sprintf( esc_html__( 'Enter a link to the profile or page on the social website. Remember to add the %s part to the front of the link.', 'upscale' ), '<code>http://</code>' ),
        'type'      => 'text',
      )
    ), $id );
  ...
  function ot_insert_css_with_markers( $field_id = '', $insertion = '', $meta = false ) {
    ...
    if ( file_exists( $filepath ) ) {
      ...
      if ( ! is_writable( $filepath ) ) {
        add_settings_error( 'option-tree', 'dynamic_css', sprintf( esc_html__( 'Unable to write to file %s.', 'upscale' ), '<code>' . $filepath . '</code>' ), 'error' );
        return false;
      }
  ...
  function ot_sections_view( $name, $key, $section = array() ) {
    ...
    <div class="option-tree-setting is-section">
      ...
      <div class="button-section">
        <a href="javascript:void(0);" class="option-tree-setting-edit option-tree-ui-button button left-item" title="' . esc_html__( 'edit', 'upscale' ) . '">
          <span class="icon ot-icon-pencil"></span>' . esc_html__( 'Edit', 'upscale' ) . '
        </a>
        <a href="javascript:void(0);" class="option-tree-setting-remove option-tree-ui-button button button-secondary light right-item" title="' . esc_html__( 'Delete', 'upscale' ) . '">
          <span class="icon ot-icon-trash-o"></span>' . esc_html__( 'Delete', 'upscale' ) . '
        </a>
      </div>
      <div class="option-tree-setting-body">
        <div class="format-settings">
          <div class="format-setting type-text">
            <div class="description">' . esc_html__( 'Section Title: Displayed as a menu item on the Theme Options page.', 'upscale' ) . '</div>
        ...
        <div class="format-settings">
          <div class="format-setting type-text">
            <div class="description">' . esc_html__( 'Section ID: A unique lower case alphanumeric string, underscores allowed.', 'upscale' ) . '</div>
            <div class="format-setting-inner">
      ...
      <div class="option-tree-setting-body">
        <div class="format-settings">
          <div class="format-setting type-text wide-desc">
            <div class="description">' . esc_html__( 'Label: Displayed as the label of a form element on the Theme Options page.', 'upscale' ) . '</div>
            <div class="format-setting-inner">
        ...
        <div class="format-settings">
          <div class="format-setting type-text wide-desc">
            <div class="description">' . esc_html__( 'ID: A unique lower case alphanumeric string, underscores allowed.', 'upscale' ) . '</div>
            <div class="format-setting-inner">
        ...
        <div class="format-settings">
          <div class="format-setting type-select wide-desc">
            <div class="description">' . esc_html__( 'Type: Choose one of the available option types from the dropdown.', 'upscale' ) . '</div>
            <div class="format-setting-inner">
        ...
        <div class="format-settings">
          <div class="format-setting type-textarea wide-desc">
            <div class="description">' . esc_html__( 'Description: Enter a detailed description for the users to read on the Theme Options page, HTML is allowed. This is also where you enter content for both the Textblock & Textblock Titled option types.', 'upscale' ) . '</div>
            <div class="format-setting-inner">
        ...
        <div class="format-settings">
          <div class="format-setting type-textblock wide-desc">
            <div class="description">' . esc_html__( 'Choices: This will only affect the following option types: Checkbox, Radio, Select & Select Image.', 'upscale' ) . '</div>
            <div class="format-setting-inner">
              ...
              <a href="javascript:void(0);" class="option-tree-choice-add option-tree-ui-button button hug-left">' . esc_html__( 'Add Choice', 'upscale' ) . '</a>
            </div>
          </div>
        </div>
        <div class="format-settings">
          <div class="format-setting type-textblock wide-desc">
            <div class="description">' . esc_html__( 'Settings: This will only affect the List Item option type.', 'upscale' ) . '</div>
            <div class="format-setting-inner">
              <ul class="option-tree-setting-wrap option-tree-sortable" data-name="' . esc_attr( $name ) . '[' . esc_attr( $key ) . ']">
                ' . ( isset( $setting['settings'] ) ? ot_loop_through_sub_settings( $name . '[' . $key . '][settings]', $setting['settings'] ) : '' ) . '
              </ul>
              <a href="javascript:void(0);" class="option-tree-list-item-setting-add option-tree-ui-button button hug-left">' . esc_html__( 'Add Setting', 'upscale' ) . '</a>
            </div>
          </div>
        </div>
        <div class="format-settings">
          <div class="format-setting type-text wide-desc">
            <div class="description">' . esc_html__( 'Standard: Setting the standard value for your option only works for some option types. Read the OptionTree->Documentation for more information on which ones.', 'upscale' ) . '</div>
            <div class="format-setting-inner">
              ' . $std_form_element . '
            </div>
          </div>
        ...
        <div class="format-settings">
          <div class="format-setting type-text wide-desc">
            <div class="description">' . esc_html__( 'Rows: Enter a numeric value for the number of rows in your textarea. This will only affect the following option types: CSS, Textarea, & Textarea Simple.', 'upscale' ) . '</div>
            <div class="format-setting-inner">
        ...
        <div class="format-settings">
          <div class="format-setting type-text wide-desc">
            <div class="description">' . esc_html__( 'Post Type: Add a comma separated list of post type like \'post,page\'. This will only affect the following option types: Custom Post Type Checkbox, & Custom Post Type Select.', 'upscale' ) . '</div>
            <div class="format-setting-inner">
        ...
        <div class="format-settings">
          <div class="format-setting type-text wide-desc">
            <div class="description">' . esc_html__( 'Taxonomy: Add a comma separated list of any registered taxonomy like \'category,post_tag\'. This will only affect the following option types: Taxonomy Checkbox, & Taxonomy Select.', 'upscale' ) . '</div>
            <div class="format-setting-inner">
        ...
        <div class="format-settings">
          <div class="format-setting type-text wide-desc">
            <div class="description">' . esc_html__( 'Min, Max, & Step: Add a comma separated list of options in the following format 0,100,1 (slide from 0-100 in intervals of 1). The three values represent the minimum, maximum, and step options and will only affect the Numeric Slider option type.', 'upscale' ) . '</div>
            <div class="format-setting-inner">
        ...
        <div class="format-settings">
          <div class="format-setting type-text wide-desc">
            <div class="description">' . esc_html__( 'CSS Class: Add and optional class to this option type.', 'upscale' ) . '</div>
            <div class="format-setting-inner">
        ...
        <div class="format-settings">
          <div class="format-setting type-select wide-desc">
            <div class="description">' . esc_html__( 'Operator: Choose the logical operator to compute the result of the conditions.', 'upscale' ) . '</div>
            <div class="format-setting-inner">
              <select name="' . esc_attr( $name ) . '[' . esc_attr( $key ) . '][operator]" value="' . $operator . '" class="option-tree-ui-select">
                <option value="and" ' . selected( $operator, 'and', false ) . '>' . esc_html__( 'and', 'upscale' ) . '</option>
                <option value="or" ' . selected( $operator, 'or', false ) . '>' . esc_html__( 'or', 'upscale' ) . '</option>
              </select>
            </div>
          </div>
        </div>
      ...
      <div class="option-tree-setting-body">
        <div class="format-settings">
          <div class="format-setting-label">
            <h5>' . esc_html__( 'Label', 'upscale' ) . '</h5>
          </div>
          <div class="format-setting type-text wide-desc">
            <div class="format-setting-inner">
        ...
        <div class="format-settings">
          <div class="format-setting-label">
            <h5>' . esc_html__( 'Value', 'upscale' ) . '</h5>
          </div>
          <div class="format-setting type-text wide-desc">
            <div class="format-setting-inner">
        ...
        <div class="format-settings">
          <div class="format-setting-label">
            <h5>' . esc_html__( 'Image Source (Radio Image only)', 'upscale' ) . '</h5>
          </div>
          <div class="format-setting type-text wide-desc">
            <div class="format-setting-inner">
      ...
      <div class="option-tree-setting-body">
        <div class="format-settings">
          <div class="format-setting type-text no-desc">
            <div class="description">' . esc_html__( 'Title: Displayed as a contextual help menu item on the Theme Options page.', 'upscale' ) . '</div>
            <div class="format-setting-inner">
        ...
        <div class="format-settings">
          <div class="format-setting type-textarea no-desc">
            <div class="description">' . esc_html__( 'Content: Enter the HTML content about this contextual help item displayed on the Theme Option page for end users to read.', 'upscale' ) . '</div>
            <div class="format-setting-inner">
...
if ( ! function_exists( 'ot_layout_view' ) ) {
  ...
  function ot_layout_view( $key, $data = '', $active_layout = '' ) {
    ...
    return '
    <div class="option-tree-setting">
      <div class="open">' . ( isset( $key ) ? esc_attr( $key ) : esc_html__( 'Layout', 'upscale' ) ) . '</div>
      <div class="button-section">
        <a href="javascript:void(0);" class="option-tree-layout-activate option-tree-ui-button button left-item' . ( $active_layout == $key ? ' active' : '' ) . '" title="' . esc_html__( 'Activate', 'upscale' ) . '">
          <span class="icon ot-icon-square-o"></span>' . esc_html__( 'Activate', 'upscale' ) . '
        </a>
        <a href="javascript:void(0);" class="option-tree-setting-remove option-tree-ui-button button button-secondary light right-item" title="'. esc_html__( 'Delete', 'upscale' ) . '">
          <span class="icon ot-icon-trash-o"></span>' . esc_html__( 'Delete', 'upscale' ) . '
        </a>
...
if ( ! function_exists( 'ot_list_item_view' ) ) {
  ...
  function ot_list_item_view( $name, $key, $list_item = array(), $post_id = 0, $get_option = '', $settings = array(), $type = '' ) {
    ...
    $required_setting = array(
      array(
        'id'        => 'title',
        'label'     => esc_html__( 'Title', 'upscale' ),
        'desc'      => '',
        'std'       => '',
        'type'      => 'text',
        'rows'      => '',
  ...
  function ot_theme_options_layouts_form( $active = false ) {
    ...
    echo '<form method="post" id="option-tree-options-layouts-form">';
      ...
      echo '<div class="option-tree-save-layout' . ( ! empty( $active_layout ) ? ' active-layout' : '' ) . '">';
        ...
        echo '<button type="submit" class="option-tree-ui-button button button-primary save-layout" title="' . esc_html__( 'New Layout', 'upscale' ) . '">' . esc_html__( 'New Layout', 'upscale' ) . '</button>';
...
function ot_meta_box_post_format_gallery( $pages = 'post' ) {
  ...
  return apply_filters( 'ot_meta_box_post_format_gallery', array(
    ...
    'title'     => esc_html__( 'Gallery', 'upscale' ),
    'desc'      => '',
    'pages'     => $pages,
    'context'   => 'side',
    'priority'  => 'low',
  ...
  return apply_filters( 'ot_meta_box_post_format_link', array(
    ...
    'fields'    => array(
      array(
        'id'      => '_format_link_url',
        'label'   => '',
        'desc'    => esc_html__( 'Link URL', 'upscale' ),
        'std'     => '',
        'type'    => 'text'
      ),
      array(
        ...
        'label'   => '',
        'desc'    => esc_html__( 'Link Title', 'upscale' ),
        'std'     => '',
        'type'    => 'text'
      )
  	)
...
function ot_meta_box_post_format_quote( $pages = 'post' ) {
  ...
  return apply_filters( 'ot_meta_box_post_format_quote', array(
    ...
    'title'     => esc_html__( 'Quote', 'upscale' ),
    'desc'      => '',
    'pages'     => $pages,
    'context'   => 'side',
    'priority'  => 'low',
    'fields'    => array(
      array(
        ...
        'label'   => '',
        'desc'    => esc_html__( 'Source Name (ex. author, singer, actor)', 'upscale' ),
        'std'     => '',
        'type'    => 'text'
      ),
      array(
        ...
        'label'   => '',
        'desc'    => esc_html__( 'Source URL', 'upscale' ),
        'std'     => '',
        'type'    => 'text'
      ),
      array(
        ...
        'label'   => '',
        'desc'    => esc_html__( 'Source Title (ex. book, song, movie)', 'upscale' ),
        'std'     => '',
        'type'    => 'text'
      ),
      array(
        ...
        'label'   => '',
        'desc'    => esc_html__( 'Source Date', 'upscale' ),
        'std'     => '',
        'type'    => 'text'
      )
  	)
...
function ot_meta_box_post_format_video( $pages = 'post' ) {
  ...
  return apply_filters( 'ot_meta_box_post_format_video', array(
    ...
    'title'     => esc_html__( 'Video', 'upscale' ),
    'desc'      => '',
    'pages'     => $pages,
    'context'   => 'side',
    'priority'  => 'low',
    'fields'    => array(
      array(
        ...
        'label'   => '',
        'desc'    => sprintf( esc_html__( 'Embed video from services like Youtube, Vimeo, or Hulu. You can find a list of supported oEmbed sites in the %1$s. Alternatively, you could use the built-in %2$s shortcode.', 'upscale' ), '<a href="http://codex.wordpress.org/Embeds" target="_blank">' . esc_html__( 'Wordpress Codex', 'upscale' ) .'</a>', '<code>[video]</code>' ),
        'std'     => '',
        'type'    => 'textarea'
      )
  	)
...
function ot_meta_box_post_format_audio( $pages = 'post' ) {
  ...
  return apply_filters( 'ot_meta_box_post_format_audio', array(
    ...
    'title'     => esc_html__( 'Audio', 'upscale' ),
    'desc'      => '',
    'pages'     => $pages,
    'context'   => 'side',
    'priority'  => 'low',
    'fields'    => array(
      array(
        ...
        'label'   => '',
        'desc'    => sprintf( esc_html__( 'Embed audio from services like SoundCloud and Rdio. You can find a list of supported oEmbed sites in the %1$s. Alternatively, you could use the built-in %2$s shortcode.', 'upscale' ), '<a href="http://codex.wordpress.org/Embeds" target="_blank">' . esc_html__( 'Wordpress Codex', 'upscale' ) .'</a>', '<code>[audio]</code>' ),
        'std'     => '',
        'type'    => 'textarea'
      )
  	)
