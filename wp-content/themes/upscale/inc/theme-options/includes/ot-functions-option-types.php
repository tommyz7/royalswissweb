...
if ( ! function_exists( 'ot_display_by_type' ) ) {
  ...
  function ot_display_by_type( $args = array() ) {
    ...
    if ( function_exists( $function_name_by_type ) ) {
      ...
      echo '<p>' . esc_html__( 'Sorry, this function does not exist', 'upscale' ) . '</p>';
    }
      ...
      echo '<div class="format-setting-inner">'; 
        ...
        echo '<div class="ot-background-group">';
          ...
          if ( in_array( 'background-repeat', $ot_recognized_background_fields ) ) {
            ...
            echo '<select name="' . esc_attr( $field_name ) . '[background-repeat]" id="' . esc_attr( $field_id ) . '-repeat" class="option-tree-ui-select ' . esc_attr( $field_class ) . '">';
              ...
              echo '<option value="">' . esc_html__( 'background-repeat', 'upscale' ) . '</option>';
          ...
          if ( in_array( 'background-attachment', $ot_recognized_background_fields ) ) {
            ...
            echo '<select name="' . esc_attr( $field_name ) . '[background-attachment]" id="' . esc_attr( $field_id ) . '-attachment" class="option-tree-ui-select ' . $field_class . '">';
              ...
              echo '<option value="">' . esc_html__( 'background-attachment', 'upscale' ) . '</option>';
          ...
          if ( in_array( 'background-position', $ot_recognized_background_fields ) ) {
            ...
            echo '<select name="' . esc_attr( $field_name ) . '[background-position]" id="' . esc_attr( $field_id ) . '-position" class="option-tree-ui-select ' . esc_attr( $field_class ) . '">';
              ...
              echo '<option value="">' . esc_html__( 'background-position', 'upscale' ) . '</option>';
          ...
          if ( in_array( 'background-size', $ot_recognized_background_fields ) ) {
            ...
            if ( is_array( $choices ) && ! empty( $choices ) ) {
              ...
              echo '<input type="text" name="' . esc_attr( $field_name ) . '[background-size]" id="' . esc_attr( $field_id ) . '-size" value="' . ( isset( $field_value['background-size'] ) ? esc_attr( $field_value['background-size'] ) : '' ) . '" class="widefat ot-background-size-input option-tree-ui-input ' . esc_attr( $field_class ) . '" placeholder="' . esc_html__( 'background-size', 'upscale' ) . '" />';
        ...
        if ( in_array( 'background-image', $ot_recognized_background_fields ) ) {
          ...
          echo '<div class="option-tree-ui-upload-parent">';
            ...
            /* input */
            echo '<input type="text" name="' . esc_attr( $field_name ) . '[background-image]" id="' . esc_attr( $field_id ) . '" value="' . ( isset( $field_value['background-image'] ) ? esc_attr( $field_value['background-image'] ) : '' ) . '" class="widefat option-tree-ui-upload-input ' . esc_attr( $field_class ) . '" placeholder="' . esc_html__( 'background-image', 'upscale' ) . '" />';
            
            /* add media button */
            echo '<a href="javascript:void(0);" class="ot_upload_media option-tree-ui-button button button-primary light" rel="' . $post_id . '" title="' . esc_html__( 'Add Media', 'upscale' ) . '"><span class="icon ot-icon-plus-circle"></span>' . esc_html__( 'Add Media', 'upscale' ) . '</a>';
          ...
          if ( isset( $field_value['background-image'] ) && $field_value['background-image'] !== '' ) {
            ...
            echo '<div class="option-tree-ui-media-wrap" id="' . esc_attr( $field_id ) . '_media">';
              ...
              echo '<a href="javascript:(void);" class="option-tree-ui-remove-media option-tree-ui-button button button-secondary light" title="' . esc_html__( 'Remove Media', 'upscale' ) . '"><span class="icon ot-icon-minus-circle"></span>' . esc_html__( 'Remove Media', 'upscale' ) . '</a>';
    ...
    echo '<div class="format-setting type-border ' . ( $has_desc ? 'has-desc' : 'no-desc' ) . '">';
      ...
      echo '<div class="format-setting-inner">';
        ...
        if ( in_array( 'width', $ot_recognized_border_fields ) ) {
          ...
          echo '<div class="ot-option-group ot-option-group--one-sixth"><input type="text" name="' . esc_attr( $field_name ) . '[width]" id="' . esc_attr( $field_id ) . '-width" value="' . esc_attr( $width ) . '" class="widefat option-tree-ui-input ' . esc_attr( $field_class ) . '" placeholder="' . esc_html__( 'width', 'upscale' ) . '" /></div>';
        ...
        if ( in_array( 'unit', $ot_recognized_border_fields ) ) {
          ...
          echo '<div class="ot-option-group ot-option-group--one-fourth">';
            ...
            echo '<select name="' . esc_attr( $field_name ) . '[unit]" id="' . esc_attr( $field_id ) . '-unit" class="option-tree-ui-select ' . esc_attr( $field_class ) . '">';
              ...
              echo '<option value="">' . esc_html__( 'unit', 'upscale' ) . '</option>';
        ...
        if ( in_array( 'style', $ot_recognized_border_fields ) ) {
          ...
          echo '<div class="ot-option-group ot-option-group--one-fourth">';
            ...
            echo '<select name="' . esc_attr( $field_name ) . '[style]" id="' . esc_attr( $field_id ) . '-style" class="option-tree-ui-select ' . esc_attr( $field_class ) . '">';
              ...
              echo '<option value="">' . esc_html__( 'style', 'upscale' ) . '</option>';
    ...
    echo '<div class="format-setting type-category-checkbox type-checkbox ' . ( $has_desc ? 'has-desc' : 'no-desc' ) . '">';
      ...
      echo '<div class="format-setting-inner">';
        ...
        if ( ! empty( $categories ) ) {
          ...
          echo '<p>' . esc_html__( 'No Categories Found', 'upscale' ) . '</p>';
        }
  ...
  function ot_type_category_select( $args = array() ) {
    ...
    echo '<div class="format-setting type-category-select ' . ( $has_desc ? 'has-desc' : 'no-desc' ) . '">';
      ...
      echo '<div class="format-setting-inner">';
        ...
        /* has cats */
        if ( ! empty( $categories ) ) {
          echo '<option value="">-- ' . esc_html__( 'Choose One', 'upscale' ) . ' --</option>';
          foreach ( $categories as $category ) {
            echo '<option value="' . esc_attr( $category->term_id ) . '"' . selected( $field_value, $category->term_id, false ) . '>' . esc_attr( $category->name ) . '</option>';
          }
        } else {
          echo '<option value="">' . esc_html__( 'No Categories Found', 'upscale' ) . '</option>';
        }
    ...
    echo '<div class="format-setting type-custom-post-type-checkbox type-checkbox ' . ( $has_desc ? 'has-desc' : 'no-desc' ) . '">';
      ...
      echo '<div class="format-setting-inner">';
        ...
        if ( is_array( $my_posts ) && ! empty( $my_posts ) ) {
          ...
          echo '<p>' . esc_html__( 'No Posts Found', 'upscale' ) . '</p>';
        }
    ...
    echo '<div class="format-setting type-custom-post-type-select ' . ( $has_desc ? 'has-desc' : 'no-desc' ) . '">';
      ...
      echo '<div class="format-setting-inner">';
        ...
        if ( is_array( $my_posts ) && ! empty( $my_posts ) ) {
          ...
          echo '<option value="">' . esc_html__( 'No Posts Found', 'upscale' ) . '</option>';
        }
      ...
      echo '<div class="format-setting-inner">';
        ...
        if ( ! empty( $ids ) ) {
          ...
          <div class="ot-gallery-buttons">
            <a href="#" class="option-tree-ui-button button button-secondary hug-left ot-gallery-delete">' . esc_html__( 'Delete Gallery', 'upscale' ) . '</a>
            <a href="#" class="option-tree-ui-button button button-primary right hug-right ot-gallery-edit">' . esc_html__( 'Edit Gallery', 'upscale' ) . '</a>
          </div>';
          ...
          echo '
          <div class="ot-gallery-buttons">
            <a href="#" class="option-tree-ui-button button button-primary right hug-right ot-gallery-edit">' . esc_html__( 'Create Gallery', 'upscale' ) . '</a>
          </div>';
  ...
  function ot_type_google_fonts( $args = array() ) {
    ...
    echo '<div class="format-setting type-google-font ' . ( $has_desc ? 'has-desc' : 'no-desc' ) . '">';
      ...
      echo '<div class="format-setting-inner">'; 
        ...
        foreach( $field_value as $key => $value ) {
          ...
          echo '<div class="type-google-font-group">';
            ...
            echo '<div class="option-tree-google-font-family">';
              echo '<a href="javascript:void(0);" class="js-remove-google-font option-tree-ui-button button button-secondary light" title="' . esc_html__( 'Remove Google Font', 'upscale' ) . '"><span class="icon ot-icon-minus-circle"/>' . esc_html__( 'Remove Google Font', 'upscale' ) . '</a>';
        ...
        echo '<a href="javascript:void(0);" class="js-add-google-font option-tree-ui-button button button-primary right hug-right" title="' . esc_html__( 'Add Google Font', 'upscale' ) . '">' . esc_html__( 'Add Google Font', 'upscale' ) . '</a>';
    ...
    echo '<div class="format-setting type-link-color ' . ( $has_desc ? 'has-desc' : 'no-desc' ) . '">';
      ...
      echo '<div class="format-setting-inner">';
        ...
        $ot_recognized_link_color_fields = apply_filters( 'ot_recognized_link_color_fields', array(
          'link'    => esc_html_x( 'Standard', 'color picker', 'upscale' ),
          'hover'   => esc_html_x( 'Hover', 'color picker', 'upscale' ),
          'active'  => esc_html_x( 'Active', 'color picker', 'upscale' ),
          'visited' => esc_html_x( 'Visited', 'color picker', 'upscale' ),
          'focus'   => esc_html_x( 'Focus', 'color picker', 'upscale' )
        ), $field_id );
  ...
  function ot_type_list_item( $args = array() ) {
    ...
    echo '<div class="format-setting type-list-item ' . ( $has_desc ? 'has-desc' : 'no-desc' ) . '">';
      ...
      echo '<div class="format-setting-inner">';
        ...
        /* button */
        echo '<a href="javascript:void(0);" class="option-tree-list-item-add option-tree-ui-button button button-primary right hug-right" title="' . esc_html__( 'Add New', 'upscale' ) . '">' . esc_html__( 'Add New', 'upscale' ) . '</a>';
        
        /* description */
        $list_desc = $sortable ? esc_html__( 'You can re-order with drag & drop, the order will update after saving.', 'upscale' ) : '';
      ...
      echo '<div class="format-setting-inner">';
        ...
        $field_choices = array(
          array(
             ...
             */
            'label'   => apply_filters( 'ot_on_off_switch_on_label', esc_html__( 'On', 'upscale' ), $field_id, 'on' )
          ),
          array(
            /**
             ...
             * @param string $filter_id For filtering both on/off label with one function.
             */
            'label'   => apply_filters( 'ot_on_off_switch_off_label', esc_html__( 'Off', 'upscale' ), $field_id, 'off' )
          )
        );
  ...
  function ot_type_page_checkbox( $args = array() ) {
    ...
    echo '<div class="format-setting type-page-checkbox type-checkbox ' . ( $has_desc ? 'has-desc' : 'no-desc' ) . '">';
      ...
      if ( is_array( $my_posts ) && ! empty( $my_posts ) ) {
        ...
        echo '<p>' . esc_html__( 'No Pages Found', 'upscale' ) . '</p>';
      }
    ...
    echo '<div class="format-setting type-page-select ' . ( $has_desc ? 'has-desc' : 'no-desc' ) . '">';
      ...
      echo '<div class="format-setting-inner">';
        ...
        if ( is_array( $my_posts ) && ! empty( $my_posts ) ) {
          ...
          echo '<option value="">' . esc_html__( 'No Pages Found', 'upscale' ) . '</option>';
        }
  ...
  function ot_type_sidebar_select( $args = array() ) {
    ...
    echo '<div class="format-setting type-sidebar-select ' . ( $has_desc ? 'has-desc' : 'no-desc' ) . '">';
      ...
      echo '<div class="format-setting-inner">';
        ...
        /* has sidebars */
        if ( count( $sidebars ) ) {
          echo '<option value="">-- ' . esc_html__( 'Choose Sidebar', 'upscale' ) . ' --</option>';
          foreach ( $sidebars as $id => $sidebar ) {
            echo '<option value="' . esc_attr( $id ) . '"' . selected( $field_value, $id, false ) . '>' . esc_attr( $sidebar ) . '</option>';
          }
        } else {
          echo '<option value="">' . esc_html__( 'No Sidebars', 'upscale' ) . '</option>';
        }
  ...
  function ot_type_slider( $args = array() ) {
    ...
    echo '<div class="format-setting type-slider ' . ( $has_desc ? 'has-desc' : 'no-desc' ) . '">';
      ...
      echo '<div class="format-setting-inner">';
        ...
        /* description */
        echo '<div class="list-item-description">' . esc_html__( 'You can re-order with drag & drop, the order will update after saving.', 'upscale' ) . '</div>';
  ...
  function ot_type_social_links( $args = array() ) {
    ...
    if ( empty( $field_value ) && apply_filters( 'ot_type_social_links_load_defaults', true, $field_id ) ) {
      ...
      $field_value = apply_filters( 'ot_type_social_links_defaults', array(
        array(
          'name'    => esc_html__( 'Facebook', 'upscale' ),
          'title'   => '',
          'href'    => ''
        ),
        array(
          'name'    => esc_html__( 'Twitter', 'upscale' ),
          'title'   => '',
          'href'    => ''
        ),
        array(
          'name'    => esc_html__( 'Google+', 'upscale' ),
          'title'   => '',
          'href'    => ''
        ),
        array(
          'name'    => esc_html__( 'LinkedIn', 'upscale' ),
          'title'   => '',
          'href'    => ''
        ),
        array(
          'name'    => esc_html__( 'Pinterest', 'upscale' ),
          'title'   => '',
          'href'    => ''
        ),
        array(
          'name'    => esc_html__( 'Youtube', 'upscale' ),
          'title'   => '',
          'href'    => ''
        ),
        array(
          'name'    => esc_html__( 'Dribbble', 'upscale' ),
          'title'   => '',
          'href'    => ''
        ),
        array(
          'name'    => esc_html__( 'Github', 'upscale' ),
          'title'   => '',
          'href'    => ''
        ),
        array(
          'name'    => esc_html__( 'Forrst', 'upscale' ),
          'title'   => '',
          'href'    => ''
        ),
        array(
          'name'    => esc_html__( 'Digg', 'upscale' ),
          'title'   => '',
          'href'    => ''
        ),
        array(
          'name'    => esc_html__( 'Delicious', 'upscale' ),
          'title'   => '',
          'href'    => ''
        ),
        array(
          'name'    => esc_html__( 'Tumblr', 'upscale' ),
          'title'   => '',
          'href'    => ''
        ),
        array(
          'name'    => esc_html__( 'Skype', 'upscale' ),
          'title'   => '',
          'href'    => ''
        ),
        array(
          'name'    => esc_html__( 'SoundCloud', 'upscale' ),
          'title'   => '',
          'href'    => ''
        ),
        array(
          'name'    => esc_html__( 'Vimeo', 'upscale' ),
          'title'   => '',
          'href'    => ''
        ),
        array(
          'name'    => esc_html__( 'Flickr', 'upscale' ),
          'title'   => '',
          'href'    => ''
        ),
        array(
          'name'    => esc_html__( 'VK.com', 'upscale' ),
          'title'   => '',
          'href'    => ''
        )
      ), $field_id );
    ...
    echo '<div class="format-setting type-social-list-item ' . ( $has_desc ? 'has-desc' : 'no-desc' ) . '">';
      ...
      echo '<div class="format-setting-inner">';
        ...
        /* button */
        echo '<a href="javascript:void(0);" class="option-tree-social-links-add option-tree-ui-button button button-primary right hug-right" title="' . esc_html__( 'Add New', 'upscale' ) . '">' . esc_html__( 'Add New', 'upscale' ) . '</a>';
        
        /* description */
        echo '<div class="list-item-description">' . apply_filters( 'ot_social_links_description', esc_html__( 'You can re-order with drag & drop, the order will update after saving.', 'upscale' ), $field_id ) . '</div>';
    ...
    echo '<div class="format-setting type-spacing ' . ( $has_desc ? 'has-desc' : 'no-desc' ) . '">';
      ...
      echo '<div class="format-setting-inner">';
        ...
        if ( in_array( 'top', $ot_recognized_spacing_fields ) ) {
          ...
          echo '<div class="ot-option-group"><span class="ot-icon-arrow-up ot-option-group--icon"></span><input type="text" name="' . esc_attr( $field_name ) . '[top]" id="' . esc_attr( $field_id ) . '-top" value="' . $top . '" class="widefat option-tree-ui-input ' . esc_attr( $field_class ) . '" placeholder="' . esc_html__( 'top', 'upscale' ) . '" /></div>';
        ...
        if ( in_array( 'right', $ot_recognized_spacing_fields ) ) {
          ...
          echo '<div class="ot-option-group"><span class="ot-icon-arrow-right ot-option-group--icon"></span></span><input type="text" name="' . esc_attr( $field_name ) . '[right]" id="' . esc_attr( $field_id ) . '-right" value="' . $right . '" class="widefat option-tree-ui-input ' . esc_attr( $field_class ) . '" placeholder="' . esc_html__( 'right', 'upscale' ) . '" /></div>';
        ...
        if ( in_array( 'bottom', $ot_recognized_spacing_fields ) ) {
          ...
          echo '<div class="ot-option-group"><span class="ot-icon-arrow-down ot-option-group--icon"></span><input type="text" name="' . esc_attr( $field_name ) . '[bottom]" id="' . esc_attr( $field_id ) . '-bottom" value="' . $bottom . '" class="widefat option-tree-ui-input ' . esc_attr( $field_class ) . '" placeholder="' . esc_html__( 'bottom', 'upscale' ) . '" /></div>';
        ...
        if ( in_array( 'left', $ot_recognized_spacing_fields ) ) {
          ...
          echo '<div class="ot-option-group"><span class="ot-icon-arrow-left ot-option-group--icon"></span><input type="text" name="' . esc_attr( $field_name ) . '[left]" id="' . esc_attr( $field_id ) . '-left" value="' . $left . '" class="widefat option-tree-ui-input ' . esc_attr( $field_class ) . '" placeholder="' . esc_html__( 'left', 'upscale' ) . '" /></div>';
    ...
    echo '<div class="format-setting type-tag-checkbox type-checkbox ' . ( $has_desc ? 'has-desc' : 'no-desc' ) . '">';
      ...
      echo '<div class="format-setting-inner">';
        ...
        if ( $tags ) {
          ...
          echo '<p>' . esc_html__( 'No Tags Found', 'upscale' ) . '</p>';
        }
    ...
    echo '<div class="format-setting type-tag-select ' . ( $has_desc ? 'has-desc' : 'no-desc' ) . '">';
      ...
      echo '<div class="format-setting-inner">';
        ...
        if ( $tags ) {
          ...
          echo '<option value="">' . esc_html__( 'No Tags Found', 'upscale' ) . '</option>';
        }
    ...
    echo '<div class="format-setting type-taxonomy-checkbox type-checkbox ' . ( $has_desc ? 'has-desc' : 'no-desc' ) . '">';
      ...
      echo '<div class="format-setting-inner">';
        ...
        if ( $taxonomies ) {
          ...
          echo '<p>' . esc_html__( 'No Taxonomies Found', 'upscale' ) . '</p>';
        }
    ...
    echo '<div class="format-setting type-tag-select ' . ( $has_desc ? 'has-desc' : 'no-desc' ) . '">';
      ...
      echo '<div class="format-setting-inner">';
        ...
        if ( $taxonomies ) {
          ...
          echo '<option value="">' . esc_html__( 'No Taxonomies Found', 'upscale' ) . '</option>';
        }
